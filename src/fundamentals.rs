...
mod literals {
    ...
    fn byte_string_literal() {
        let answer: &[u8] = "Hello, world!".as_bytes();
...
mod expressions {
    ...
    fn boolean_bit_operator_expression() {
        let answer: bool = 4 & 1 == 1;
        assert_eq!(answer, false);
    }

    #[test]
    fn if_else_expression() {
        let answer: i32 = if 1 == 1 { 1 } else { 0 };
        assert_eq!(answer, 1);
    }
